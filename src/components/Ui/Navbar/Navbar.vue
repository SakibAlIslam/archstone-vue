...
<template>
    <header class="relative flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-slate-100 text-sm py-4 px-6 dark:bg-gray-800">
        <nav class="global-container w-full mx-auto sm:flex sm:items-center sm:justify-between" aria-label="Global">
            ...
            <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
                ...
                <!-- listing start-->
                <div class="listing-dropdown hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none]">
