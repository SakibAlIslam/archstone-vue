<template>
    <!-- FAQ -->
    <div class="global-container px-4 py-10 sm:px-6 lg:px-0 lg:py-14 mx-auto">
    <!-- Grid -->
        <div class="grid md:grid-cols-5 gap-4 lg:gap-10">
            <div class="md:col-span-2">
            <div class="max-w-xs">
                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight text-primary dark:text-white">Frequently<br>asked questions</h2>
                <p class="mt-1 hidden md:block text-gray-700 dark:text-gray-400">Answers to the most frequently asked questions.</p>
            </div>
            </div>
            <!-- End Col -->
