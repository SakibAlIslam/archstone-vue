...
<template>
  <!-- Hero -->
  <div
    class="min-h-max lg:min-h-[90vh] mx-auto px-4 sm:px-6 lg:px-0 relative flex items-center justify-center"
  >
    <div class="global-container mt-2 lg:-mt-20">
      <div
        class="flex flex-col lg:flex-row gap-4 md:gap-8 xl:gap-10 items-center justify-between"
      >
        <div class="hero-left flex-1">
          ...
          >
            ...
            <span class="text-primary font-bold">ARCHSTONE</span>
          </h1>
          ...
          <div class="mt-7 grid gap-3 w-full sm:inline-flex">
            <a
              class="inline-flex justify-center items-center gap-x-3 text-center bg-primary hover:bg-green-700 border border-transparent text-sm lg:text-base text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition py-3 px-4 dark:focus:ring-offset-gray-800"
              href="#"
            >
              Get started
              <svg
            ...
            <a class="Button--gradient py-5 px-10 text-white rounded-xl" href="#">
              Get started
            </a>
            <a
...
.Button--gradient {
  --Button--gradient-size: 2px;
  --Button--gradient-bg-color: var(--site-bg-color);
  --Button--gradient-bg-image: linear-gradient(
    166deg,
    #ff507a,
    #7d51df 33%,
    #2265de 66%,
  ...
  border: var(--Button--gradient-size) solid transparent;
  box-shadow: none;
}
...
.Button--gradient:before {
    ...
    left: 0;
    z-index: -1;
    margin: calc(-1 * var(--Button--gradient-size));
    content: "";
    background-image: var(--Button--gradient-bg-image);
